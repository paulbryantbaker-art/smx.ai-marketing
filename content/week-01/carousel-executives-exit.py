#!/usr/bin/env python3
"""
smbx.ai LinkedIn Carousel — Monday Post 3: Executives
"Strategic Exit" — Executive Suite (380K)
...
Deck rhythm:
  S1 cover    LIGHT  Field Note masthead, mega-compare ($100M → $140M)
  S2          LIGHT  Run a process — dark KV card with funnel
  S3          LIGHT  Control the narrative — bordered card before/after
  S4          DARK   Cinematic anchor — light card with $40M tension math
  S5 close    LIGHT  Sora prompt + dark ring-CTA block

Usage:
    python3 carousel-executives-exit.py            # light deck (default)
    python3 carousel-executives-exit.py dark
"""
...
S1 = wrap(f"""
    ...
    <div class="eyebrow-hook">
      <span class="dot"></span>
      <span>Lower-mid market &nbsp;·&nbsp; $20M EBITDA &nbsp;·&nbsp; Strategic exit</span>
    </div>

    <h1 class="hook" style="font-size:96px;">
      One buyer.<br>Or three.
    </h1>

    <div class="mega-compare">
      <div class="mega-row">
        <span class="label">Single buyer offer</span>
        <span class="val muted num">$100M</span>
      </div>
      <div class="mega-row">
        <span class="label">Process: 52 contacted &rarr; 4 finalists</span>
        <span class="val accent num">$140M</span>
      </div>
      <div class="mega-gap">
        <span class="label">Premium from competition</span>
        <span class="val num">$40M</span>
      </div>
    </div>
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# SLIDE 2 — Run a process
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
S2 = wrap(f"""
    <div class="eyebrow-section">1 &middot; Run a process</div>

    <h1 class="section" style="font-size:60px;">
      One buyer is a price. Three buyers are a market.
    </h1>

    <div class="kv-card-dark">
      <div class="row">
        <span class="k">Business</span>
        <span class="v num">$20M EBITDA manufacturer</span>
      </div>
      <div class="row">
        <span class="k">Single buyer offer</span>
        <span class="v num">$100M</span>
      </div>
      <div class="row">
        <span class="k">Process</span>
        <span class="v num">52 &rarr; 18 NDAs &rarr; 4 finalists</span>
      </div>
      <div class="row">
        <span class="k">Closed at</span>
        <span class="v num accent">$140M</span>
      </div>
    </div>
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# SLIDE 3 — Control the narrative
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
S3 = wrap(f"""
    <div class="eyebrow-section">2 &middot; Control the narrative</div>

    <h1 class="section" style="font-size:64px;">
      An IT services company added <span class="num">$15.6M</span> with one sentence.
    </h1>

    <div class="kv-card">
      <div class="row">
        <span class="k">Before</span>
        <span class="v">Managed services provider</span>
      </div>
      <div class="row">
        <span class="k">After</span>
        <span class="v" style="font-size:26px;">Recurring-revenue platform &middot; $200B fragmented market &middot; 95% retention</span>
      </div>
      <div class="row">
        <span class="k">Multiple</span>
        <span class="v num">5.5&times; &rarr; 9.4&times;</span>
      </div>
      <div class="row">
        <span class="k">Same business</span>
        <span class="v num accent">+$15.6M</span>
      </div>
    </div>
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
# SLIDE 4 — Cinematic anchor: $40M from competitive tension
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
S4 = wrap(f"""
    <div class="eyebrow-section">The math of competitive tension</div>
    ...
    <div class="light-card">
      <div class="anchor-eyebrow">$20M EBITDA manufacturer</div>

      <div class="row-line">
        <span class="k">One buyer who&rsquo;d been circling</span>
        <span class="v num">$100M</span>
      </div>
      <div class="row-line">
        <span class="k">Real process &nbsp;·&nbsp; 4 finalists</span>
        <span class="v num">$140M</span>
      </div>

      <div class="gap-row">
        <span class="k">Premium</span>
        <span class="v num">$40M</span>
      </div>

      <div class="caption">
        Same balance sheet. Same EBITDA. Same week. Different process.
      </div>
    </div>
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
S5 = wrap(f"""
    <div class="eyebrow-section">The top quartile</div>

    <h1 class="section" style="font-size:72px;">
      Four moves separate the top quartile from the median.
    </h1>

    <p class="sub">
      <strong>Run a process.</strong> Control the narrative.
      Fix problems before listing. Know your number cold.
    </p>

    <div class="cta-ring">
      <div class="cta-eyebrow">Free &middot; 12 minutes</div>
      <h2>Map your strategic exit with Baseline&trade;.</h2>
      <span class="pill">
...
pdf_path = OUT_DIR / f"MON-3-executives-exit-{MODE}.pdf"
